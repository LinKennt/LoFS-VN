...
define gui.text_font = "seagull-wine-regular.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "seagull-wine-regular.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "seagull-wine-regular.ttf"
