...
define config.name = _("Library of Furry Stories")
...
define gui.about = _p("""Посвещено Discord серверу "Библиотека Пушистых Историй". Насколько бы старым участником БПИ ты не был или была, знай, ты всё равно лучше всех. Я вас обожаю, ребят, а если и ругаюсь то только любя и для вас же.

Автор - Lin Kennt (Lin#4463) и Пользователи сервера Библиотека Пушистых Историй
""")
...
define config.save_directory = "Nownovell-1623017673"
